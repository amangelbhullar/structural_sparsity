...
class SDGNN(nn.Module):
    """
    SD-GNN: globally learned structural sparsification.
    Unlike ASR-GNN, gating is not query-conditioned per triple semantics,
    but based on edge structure embeddings.
    """
    ...
    def forward_components(self, triples: torch.Tensor):
        ...
        alpha = self.edge_scorer(gate_input)
